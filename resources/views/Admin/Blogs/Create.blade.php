                ...
                <div class="col-xl-12 mx-auto">
                    <div class="card">
                        <div class="card-header px-4 py-3">
                            <h5 class="mb-0">
                                <i class="bx bx-user"></i> Create Blog
                        ...
                        <div class="card-body p-4">
                            <form class="row g-3 needs-validation" id="create-form" method="post" enctype="multipart/form-data">
                                    ...
                                    <select name="Blog_Cat_Id" id="Blog_Cat_Id" class="form-control" required>
                                        ...
                                        @if($Blog_Categories->isNotEmpty())
                                            @foreach($Blog_Categories as $Blog_Key => $Blog_Cat)
                                                <option value="{{ $Blog_Key }}">{{ $Blog_Cat }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                ...
                                /*
                                <div class="col-md-6">
                                    <label for="Blog_Sub_Cat_Id" class="form-label">Blog Category</label>
                                    <select name="Blog_Sub_Cat_Id" id="Blog_Sub_Cat_Id" class="form-control">
                                        <option value="">Select Category</option>
                                        @if($Blog_Categories->isNotEmpty())
                                            @foreach($Blog_Categories as $Blog_Key => $Blog_Cat)
                                                <option value="{{ $Blog_Key }}">{{ $Blog_Cat }}</option>
