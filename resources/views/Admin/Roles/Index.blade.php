...
@php
    $Auth_User = auth()->user();
    $Is_Add = $Auth_User->HasPermission('Roles', 'Is_Add');
@endphp
<div class="page-wrapper">
    <div class="page-content">
        <!--breadcrumb-->
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Roles
            </div>
            <div class="ps-3">
            ...
            @if($Is_Add)
                <a href="{{ route('role.create') }}" class="btn btn-primary float-end">Add</a>
            @endif
        </div>
        <!--end breadcrumb-->
        <div class="main-body">
...
@push('js')
    <script type="text/javascript">
        ...
        const Create_Update_Role_Permissions = (id) =>
        {
            $.confirm({
                title : 'Confirm!',
                content : 'Are sure you want to update permission',
                buttons : {
                    cancel : () => {
