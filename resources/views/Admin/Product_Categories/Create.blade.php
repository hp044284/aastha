            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create Product Categories</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="col-xl-12 mx-auto">
                    <div class="card">
                        <div class="card-header px-4 py-3">
                            <h5 class="mb-0">
                                <i class="bx bx-user"></i> Create Product Categories
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="image-container">
                                                ...
                                                <input type="file" name="File_Name" class="form-control" id="fileInput" accept="image/*" style="display: none;">
