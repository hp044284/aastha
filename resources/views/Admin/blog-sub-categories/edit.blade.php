...
@section('title', "Edit Blog Sub Categories")
@section('content')
@push('css')
    <style type="text/css">
    .image-container {
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Edit Blog Sub Categories</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Blog Sub Categories</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="col-xl-12 mx-auto">
                    <div class="card">
                        <div class="card-header px-4 py-3">
                            <h5 class="mb-0">
                                <i class="bx bx-user"></i> Edit Blog Sub Categories
                                <a href="{{ route('blog_sub_category.index',$Parent_Random_Id) }}" class="btn btn-primary float-end">Back</a>
                            </h5>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $('#edit-form').submit(function(e)
        {
            ...
            const axios_request = sendAxiosRequest({
                url : "{{ route('blog_sub_category.update') }}",
                data : formData,
