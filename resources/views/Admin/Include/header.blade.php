        ...
        <nav class="navbar navbar-expand gap-3">
                                    ...
                                    <div class="col">
                                        <a href="javascript:;">
                                            <div class="app-box text-center">
                                                <div class="app-icon">
                                                    <img src="{{ secure_asset('assets/images/app/slack.png') }} " width="30" alt="" />
                                                </div>
                                                <div class="app-name">
                    ...
                    <li class="nav-item dropdown dropdown-large">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" data-bs-toggle="dropdown">
                            @if ($EnquiryCount && $EnquiryCount > 0)
                                <span class="alert-count">{{ $EnquiryCount  ?? 0 }}</span>
                            @endif
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="javascript:;">
                                <div class="msg-header">
                                    ...
                                    <p class="msg-header-badge">{{ $EnquiryCount ?? 0 }} New</p>
                                </div>
                            </a>
                            <div class="header-notifications-list">
                                @foreach($EnquiryNoti as $EnquiryKey => $Enquiry)
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="d-flex align-items-center">
                                            <div class="notify bg-light-danger {{ randomTextClass() }}">{{getInitials($Enquiry->Name??'')}}</div>
                                            <div class="flex-grow-1">
                                                <h6 class="msg-name">New Enquiry <span class="msg-time float-end">{{ timeAgo($Enquiry->created_at) }}</span></h6>
                                                <p class="msg-info">You have recived new enquiry</p>
                                            </div>
                                        </div>
                                    </a>
                                @endforeach
                            ...
                            @if ($EnquiryCount && $EnquiryCount > 0)
                                <a href="{{ route('enquiry.index') }}">
                                    <div class="text-center msg-footer">
                                        <button class="btn btn-primary w-100">View All Enquiries</button>
                                    </div>
                                </a>
                            @endif
                        </div>
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ asset('Uploads/users/' . auth()->user()->File_Name) }} " class="user-img" alt="user avatar" />
                    <div class="user-info">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('user.change_password') }}">
