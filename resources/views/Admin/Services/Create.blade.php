                                ...
                                <div class="border border-3 p-4 rounded">
                                    <div class="row g-3">
                                            ...
                                            <select class="form-select" id="Category_Id" name="Category_Id">
                                                ...
                                                @if(!empty($sub_categories))
                                                    @foreach($sub_categories as $service_key => $service_cat)
                                                        <option value="{{$service_key}}">{{ $service_cat }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                        <div class="col-12">
                                            <label for="Sub_Category_Id" class="form-label">Service Sub Category</label>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="Tags" rows="3" name="Tags" placeholder="Enter Service Tags"></textarea>
                                        </div>
                                        <div class="col-12">
