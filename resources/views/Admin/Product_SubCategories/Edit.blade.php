...
@section('title', "Edit Product Sub Categories")
@section('content')
@push('css')
    <style type="text/css">
    .image-container {
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Edit Product Sub Categories</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Product Sub Categories</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="col-xl-12 mx-auto">
                    <div class="card">
                        <div class="card-header px-4 py-3">
                            <h5 class="mb-0">
                                <i class="bx bx-user"></i> Edit Product Sub Categories
                                <a href="{{ route('product_sub_category.index',$Parent_Random_Id) }}" class="btn btn-primary float-end">Back</a>
                            </h5>
                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="image-container">
                                                <label for="fileInput" class="image-preview">
                                                    @if(!empty($entity->File_Name) && (File::exists(public_path('/Uploads/Product_Categories/'.$entity->File_Name))))
                                                        @php
                                                            $is_primary_required = true;
                                                        @endphp
                                                        <img id="previewImage" src="{{ asset('Uploads/Product_Categories/'.$entity->File_Name) }}" alt="Select an image">
                                                    @else
    ...
    <script type="text/javascript">
        ...
        $('#edit-form').submit(function(e)
        {
            ...
            const axios_request = sendAxiosRequest({
                url : "{{ route('product_sub_category.update') }}",
                data : formData,
