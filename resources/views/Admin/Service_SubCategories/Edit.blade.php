...
@section('title', "Edit Service Sub Categories")
@section('content')
@push('css')
    <style type="text/css">
    .image-container {
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Edit Service Sub Categories</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Service Sub Categories</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="col-xl-12 mx-auto">
                    <div class="card">
                        <div class="card-header px-4 py-3">
                            <h5 class="mb-0">
                                <i class="bx bx-user"></i> Edit Service Sub Categories
                                <a href="{{ route('service_sub_category.index',$Parent_Random_Id) }}" class="btn btn-primary float-end">Back</a>
                            </h5>
                        </div>
                        <div class="card-body p-4">
                            <form class="row g-3 needs-validation" id="edit-form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="Subtitle" class="form-control" id="Subtitle" placeholder="Subtitle" value="{{ old('Subtitle', $entity->Subtitle) }}" required>
                                </div>

                                <div class="col-md-6">
                                    <label for="Icon" class="form-label">Icon</label>
                                    <input type="text" name="Icon" class="form-control" id="Icon" placeholder="Icon" value="{{ old('Icon', $entity->Icon) }}" required>
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="image-container">
                                                <label for="fileInput" class="image-preview">
                                                    @if(!empty($entity->File_Name) && (File::exists(public_path('/Uploads/Service_Categories/'.$entity->File_Name))))
                                                        @php
                                                            $is_primary_required = true;
                                                        @endphp
                                                        <img id="previewImage" src="{{ asset('Uploads/Service_Categories/'.$entity->File_Name) }}" alt="Select an image">
                                                    @else
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $('#edit-form').submit(function(e)
        {
            ...
            formData.append('Parent_Random_Id',"{{ $Parent_Random_Id ?? 0}}")

            const axios_request = sendAxiosRequest({
                url : "{{ route('service_sub_category.update') }}",
                data : formData,
