...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Service
            </div>
            <div class="ps-3">
            ...
            <a href="{{ route('service.create',$Random_Id) }}" class="btn btn-primary float-end">Add</a>
        </div>
        <!--end breadcrumb-->
        <div class="main-body">
            <div class="row">
    ...
    <script type="text/javascript">
        $(document).ready(function()
        {
            ...
            $('#datatable').DataTable({
                info : false,
                ajax : {
                    url : "{{ route('service.axios_record') }}",
                    method : 'POST',
                    data : function(d)
                    {
