...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Edit Service Categories</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Service Categories</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="col-xl-12 mx-auto">
                    <div class="card">
                        <div class="card-header px-4 py-3">
                            <h5 class="mb-0">
                                <i class="bx bx-user"></i> Edit Service Categories
                                <a href="{{ route('service_category.index') }}" class="btn btn-primary float-end">Back</a>
                            </h5>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $('#edit-form').submit(function(e)
        {
            ...
            const axios_request = sendAxiosRequest({
                url : "{{ route('service_category.update') }}",
                data : formData,
