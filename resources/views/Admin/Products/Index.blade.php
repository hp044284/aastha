...
@php
    $Auth_User = auth()->user();
    $Is_Add = $Auth_User->HasPermission('Products', 'Is_Add');
@endphp
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Products
            </div>
            <div class="ps-3">
            ...
            @if($Is_Add)
                <a href="{{ route('product.create') }}" class="btn btn-primary float-end">Add</a>
            @endif
        </div>
        <!--end breadcrumb-->
        <div class="main-body">
    ...
    <script type="text/javascript">
        $(document).ready(function()
        {
            ...
            $('#datatable').DataTable({
                info : false,
                ajax : {
                    url : "{{ route('product.axios_record') }}",
                    method : 'POST',
                    data : function(d)
                    {
                        d.Random_Id = "0";
