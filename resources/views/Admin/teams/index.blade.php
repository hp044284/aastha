...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Team Members
            </div>
            <div class="ps-3">
...
@push('js')
<script>
    // Example: Open offcanvas and load team member details via AJAX
    const showTeamOffcanvas = (teamId) => {
        showDynamicComponent(
            'teamOffcanvas', // offcanvas ID
            'teamOffcanvasContent', // content container ID
            `{{ route('teams.show', ':id') }}`.replace(':id', teamId),
            'offcanvas'
        );
    };
</script>
