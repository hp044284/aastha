                ...
                <div class="col-xl-12 mx-auto">
                    <div class="card">
                        <div class="card-header px-4 py-3">
                            <h5 class="mb-0">
                                <i class="bx bx-user"></i> Edit Clients
                        ...
                        <div class="card-body p-4">
                            <form class="row g-3 needs-validation" id="edit-form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if(!empty($entity->File_Name) && (File::exists(public_path('/Uploads/Clients/'.$entity->File_Name))))
                                        <div id="primary-file-preview" class="file-preview-container" style="margin-top: 10px;">
                                            <img src="{{ asset('public/Uploads/Clients/'.$entity->File_Name) }}" alt="282X300.jpg" style="max-width: 150px; margin-right: 10px;">
                                        </div>
                                    @else
