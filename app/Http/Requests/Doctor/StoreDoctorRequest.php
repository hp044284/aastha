...
class StoreDoctorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'education.*.start_year' => "nullable|integer|min:1900|max:$currentYear",
            'education.*.end_year' => "nullable|integer|min:1900|max:$currentYear|gte:education.*.start_year",
            'positions' => 'nullable|array',
            'positions.*.position_title' => 'required|string|max:255',
            'positions.*.organization' => 'required|string|max:255',
            'positions.*.start_year' => "nullable|integer|min:1900|max:$currentYear",
            'positions.*.end_year' => "nullable|integer|min:1900|max:$currentYear|gte:positions.*.start_year",
