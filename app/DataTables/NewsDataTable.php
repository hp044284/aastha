...
class NewsDataTable extends DataTable
{
     ...
     *
     * @param QueryBuilder<News> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            {
                $model = request()->segment(2); // e.g. "news"
            ...
            ->addColumn('action', function($row) {
                return view('Admin.news.action', compact('row'))->render();
            })
            ->setRowId('id');
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('title'),
            Column::make('event_id')->title('Event'),
            Column::make('status'),
